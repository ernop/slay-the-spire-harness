...
namespace StS
{
    public class Fight
    {
        ...
        public Fight(GameContext gameContext, Deck deck, Player player, List<Enemy> enemies)
        {
        ...
        public Fight(GameContext context, Deck deck, Player player, Enemy enemy)
        {
        ...
        public void PlayCard(CardInstance cardInstance, Player player, Enemy enemy)
        {
            ...
            cardInstance.Play(ef, player, target, cardInstance.UpgradeCount);
        ...
        {
            var ef = new EffectSet();
            cardInstance.Play(ef, player, enemy, cardInstance.UpgradeCount);
