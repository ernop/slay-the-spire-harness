...
namespace StS
{
    public class GenericEnemy : Enemy, IEnemy
    {
        ...
        {
            return new FightAction(FightActionEnum.EnemyMove, card: new CardInstance(new EnemyCard(targetType: TargetType.Player, Amount, Count), 0), hadRandomEffects: true, key: 1);
        }
